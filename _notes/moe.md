...
date: 2025-03-07
description: MoE layer is a replacement for the FFN (dense MLP) layer in LLMs.
categories: research
tags: LLM_Inference
...
toc:
  ...
  - name: Mixtral
    subsections:
      - name: "Case: Mixtral8x7B"
  - name: Load Balancing
---

[Mixtral of Experts](https://arxiv.org/abs/2401.04088) <d-cite key="mixtral" />  
[DeepSeek V3 Technical Report](https://arxiv.org/abs/2412.19437) <d-cite key="deepseekv3" />  
...
<div class="row mt-3">
    <div class="col-lg mt-3 mt-md-0">
        {% include figure.liquid path="assets/notes/deepseekv3.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
## Mixtral
Mixtral <d-cite key="mixtral" /> is one of the earliest MoE model. The router network is defined as 
...
Each expert is just a FFN layer, Mixtral uses SwiGLU from Llama2 <d-cite key="llama2" />. 

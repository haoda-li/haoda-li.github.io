---
layout: distill
title: Paged Attention & Automatic Prefix Caching
date: 2026-06-13
description: A concise explanation of paged attention and automatic prefix caching in vLLM.
categories: research
tags: LLM_Inference
...
toc:
  - name: "Pre-req: Scaled Dot-Product Attention"
  - name: Paged Attention
    subsections:
      - name: Online Softmax
      - name: Why Paged Attention Is More Efficient
  - name: Automatic Prefix Caching (APC)
    subsections:
      - name: Block Identification
      - name: Allocation Flow for a New Request
      - name: Eviction Policy (LRU)
---

...
title: LLM Basics
date: 2025-05-09
description: Transformer-based large language models, their inference pass, and some implementation basics
categories: research
tags: LLM_Inference
...
toc:
  ...
  - name: Attention Module
    subsections:
      ...
      - name: Group Query (GQA) and Multi-query (MQA)
      - name: Causal Masking
      - name: KV Caching for Casual Inference
      - name: Putting all Together
  - name: Feed forward Network
  - name: Inference Acceleration and Performance Evaluation
    subsections:
...
<div class="row mt-3">
    <div class="col-lg mt-3 mt-md-0">
        {% include figure.liquid path="assets/notes/tokenizer.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-lg mt-3 mt-md-0">
        {% include figure.liquid path="assets/notes/llama_vs_gpt.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>

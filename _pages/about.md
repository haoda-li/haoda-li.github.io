...
title: Profile
permalink: /
subtitle: Software Engineer in Graphics / ML Systems
...
<div class="cv">
    ...
    <!-- JSONResume Sections - Work Experience -->
    {% assign empty_array = '' | split: ',' %}
    ...
    <!-- JSONResume Sections - Research and Teaching -->
    {% assign empty_array = '' | split: ',' %}
